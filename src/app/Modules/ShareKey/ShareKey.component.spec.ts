...
import {ShareKeyComponent} from './ShareKey.component';
import {ShareKeyService} from './ShareKey.service';
import {Observable} from 'rxjs';

describe('EncryptKeyComponent', () => {
	let component: ShareKeyComponent;
	let fixture: ComponentFixture<ShareKeyComponent>;
	...
	beforeEach(async(() => {
		...
		mockEmployeeService = sinon.createStubInstance(ShareKeyService);
		mockEmployeeService.getAll.returns([]);
		mockDataService = sinon.createStubInstance(DataService);

		TestBed.configureTestingModule({
			declarations: [ShareKeyComponent],
			imports: [
				BrowserModule,
				FormsModule,
				ReactiveFormsModule,
			...
			providers: [
				{provide: ShareKeyService, useValue: mockEmployeeService},
				{provide: DataService, useValue: mockDataService},
			]
		});

		fixture = TestBed.createComponent(ShareKeyComponent);
