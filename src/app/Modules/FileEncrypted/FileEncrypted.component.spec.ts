...
import {UserComponent} from './FileEncrypted.component';
...
describe('LogComponent', () => {
	...
	beforeEach(async(() => {
		...
		mockEmployeeService = sinon.createStubInstance(FileEncryptedService);
		...
		TestBed.configureTestingModule({
			...
			providers: [
				{provide: FileEncryptedService, useValue: mockEmployeeService},
