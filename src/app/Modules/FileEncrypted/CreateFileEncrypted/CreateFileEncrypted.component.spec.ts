...
import {UserComponent} from './CreateFileEncrypted.component';
...
describe('LogComponent', () => {
	...
	beforeEach(async(() => {
		...
		mockEmployeeService = sinon.createStubInstance(CreateFileEncryptedService);
		...
		TestBed.configureTestingModule({
			...
			providers: [
				{provide: CreateFileEncryptedService, useValue: mockEmployeeService},
