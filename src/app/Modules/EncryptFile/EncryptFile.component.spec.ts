...
import {EncryptFileComponent} from './EncryptFile.component';
import {EncryptFileService} from './EncryptFile.service';
import {Observable} from 'rxjs';

describe('EncryptKeyComponent', () => {
	let component: EncryptFileComponent;
	let fixture: ComponentFixture<EncryptFileComponent>;
	...
	beforeEach(async(() => {
		...
		mockEmployeeService = sinon.createStubInstance(EncryptFileService);
		mockEmployeeService.getAll.returns([]);
		mockDataService = sinon.createStubInstance(DataService);

		TestBed.configureTestingModule({
			declarations: [EncryptFileComponent],
			imports: [
				BrowserModule,
				FormsModule,
				ReactiveFormsModule,
			...
			providers: [
				{provide: EncryptFileService, useValue: mockEmployeeService},
				{provide: DataService, useValue: mockDataService},
			]
		});

		fixture = TestBed.createComponent(EncryptFileComponent);
