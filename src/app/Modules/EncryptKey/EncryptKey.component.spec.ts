...
import {EncryptKeyComponent} from './EncryptKey.component';
import {EncryptKeyService} from './EncryptKey.service';
import {Observable} from 'rxjs';

describe('EncryptKeyComponent', () => {
	let component: EncryptKeyComponent;
	let fixture: ComponentFixture<EncryptKeyComponent>;
	...
	beforeEach(async(() => {
		...
		mockEmployeeService = sinon.createStubInstance(EncryptKeyService);
		mockEmployeeService.getAll.returns([]);
		mockDataService = sinon.createStubInstance(DataService);

		TestBed.configureTestingModule({
			declarations: [EncryptKeyComponent],
			imports: [
				BrowserModule,
				FormsModule,
				ReactiveFormsModule,
			...
			providers: [
				{provide: EncryptKeyService, useValue: mockEmployeeService},
				{provide: DataService, useValue: mockDataService},
			]
		});

		fixture = TestBed.createComponent(EncryptKeyComponent);
