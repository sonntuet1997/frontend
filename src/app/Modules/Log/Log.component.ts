...
@Component({
	...
	providers: [LogService, CreateUserService, UpdateUserService]
})
export class LogComponent extends IComponent<User> {
	public title = 'Người dùng';
	public SexList = SexList;

	constructor(userService: LogService, toastr: BottomToastsManager, create: CreateUserService,
