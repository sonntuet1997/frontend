...
import {UpdateFileService} from './UpdateFile.service';
...
describe('UpdateUserComponent', () => {
	...
	beforeEach(async(() => {
		...
		mockCreateDemoService = sinon.createStubInstance(UpdateFileService);
		...
		TestBed.configureTestingModule({
			...
			providers: [
				{provide: UpdateFileService, useValue: mockCreateDemoService},
