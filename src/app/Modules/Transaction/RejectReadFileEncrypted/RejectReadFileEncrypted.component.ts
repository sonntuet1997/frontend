...
@Component({
	...
	templateUrl: './RejectReadFileEncrypted.component.html',
	styleUrls: ['./RejectReadFileEncrypted.component.css'],
	providers: [RejectReadFileEncryptedService]
})
export class RejectReadFileEncryptedComponent implements OnInit {
	...
	constructor(private serviceCreateDemo: RejectReadFileEncryptedService, public toastr: BottomToastsManager, fb: FormBuilder) {
