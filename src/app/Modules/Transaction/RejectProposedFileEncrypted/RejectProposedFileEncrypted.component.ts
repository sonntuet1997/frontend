...
@Component({
	...
	templateUrl: './RejectProposedFileEncrypted.component.html',
	styleUrls: ['./RejectProposedFileEncrypted.component.css'],
	providers: [RejectProposedFileEncryptedService]
})
export class RejectProposedFileEncryptedComponent implements OnInit {
	...
	constructor(private serviceCreateDemo: RejectProposedFileEncryptedService, public toastr: BottomToastsManager, fb: FormBuilder) {
