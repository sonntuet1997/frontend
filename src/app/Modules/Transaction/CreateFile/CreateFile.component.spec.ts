...
import {CreateFileService} from './CreateFile.service';
...
describe('UpdateUserComponent', () => {
	...
	beforeEach(async(() => {
		...
		mockCreateDemoService = sinon.createStubInstance(CreateFileService);
		...
		TestBed.configureTestingModule({
			...
			providers: [
				{provide: CreateFileService, useValue: mockCreateDemoService},
