...
@Component({
	...
	templateUrl: './ProposeReadFileEncrypted.component.html',
	styleUrls: ['./ProposeReadFileEncrypted.component.css'],
	providers: [ProposeReadFileEncryptedService]
})
export class ProposeReadFileEncryptedComponent implements OnInit {
	...
	constructor(private serviceCreateDemo: ProposeReadFileEncryptedService, public toastr: BottomToastsManager, fb: FormBuilder) {
