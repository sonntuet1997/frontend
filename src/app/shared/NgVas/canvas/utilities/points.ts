 ...
 */
function YBX(a: { x: number, y: number }, b: { x: number, y: number }, c: { x: number, y: number }, d: { x: number, y: number }, x: number) {

	const
		A = d.x - (3 * c.x) + (3 * b.x) - a.x,
		B = (3 * c.x) - (6 * b.x) + (3 * a.x),
		C = (3 * b.x) - (3 * a.x),
		D = a.x - x;
 ...
 */
function Bezier(a: { x: number, y: number }, b: { x: number, y: number }, c: { x: number, y: number }, d: { x: number, y: number }, t: number) {
