import {ContextTransformer, IShape, ShapeType} from './interfaces';
import {ConstraintFunction, IConstrainable} from '../constraints/interfaces';
import {HitAreaConstructor, IHitArea} from '../hit-area/interfaces';
...
export abstract class BaseShape implements IShape, ITraceable, IConstrainable {
	...
	public get hitArea(): IHitArea | undefined {
	...
	public get originToCenter() {
		return this._originToCenter;
	}
	...
	public get contextTransform(): ContextTransformer {
		return Object.assign({}, this._currentCtxt);
	}
